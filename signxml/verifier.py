...
class VerifyResult:
    ...
    verification contain the signed bytes, the parsed signed XML, the parsed signature XML, the key that was used
    to verify the signature, and the URI of the signature reference that was validated. Example usage:
